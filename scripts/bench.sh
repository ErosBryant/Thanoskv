...
outfilepath="/home/eros/workspace-lsm/Thanoskv2/bench_result"
# output file
...
# value array 65536
value_array=(128 256 1024 4096 16384 )
...
cat $outfilepath/value_size-${size}.out | grep "fillrandom  "
echo "--------------------------------------------------------"
echo "random read             latency       throughput"
cat $outfilepath/value_size-${size}.out | grep "readrandom  "
echo ""
}
...
RUN_VALUE_TEST() {
    ...
    for value in ${value_array[@]}; do
        ...
        outfile="$outfilepath/value_size-${size}.out"
        RUN_ONE_TEST
        PARSER >> "$outfile"
        sleep 5
    done
